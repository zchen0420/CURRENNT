...
namespace data_sets {
    ...
    private:
        ...
        Cpu::real_vector _loadInputMultiplyersFromCache(const sequence_t &seq);
    ...
    public:
        ...
        /**
         * Returns the input means (per feature) indicated in the NC file
         *
         * @return vector of output means
         */
        Cpu::real_vector inputMeans() const;

        /**
         * Returns the input standard deviations (per feature) indicated in the NC file
         *
         * @return vector of output standard deviations
         */
        Cpu::real_vector inputStdevs() const;
