...
#include "layers/NoIgLstmLayer.hpp"
#include "layers/NoIgOgLstmLayer.hpp"
#include "layers/GruLayer.hpp"
#include "layers/SsePostOutputLayer.hpp"
#include "layers/RelativeSsePostOutputLayer.hpp"
        ...
        int maxSeqLength, layers::Layer<TDevice> *precedingLayer)
{
    ...
    if (layerType == "input")
    ...
    else if (layerType == "feedforward_softplus")
    	return new FeedForwardLayer<TDevice, Softplus>(layerChild, weightsSection, *precedingLayer);
    ...
    else if (layerType == "nilstm")
    	return new NoIgLstmLayer<TDevice>(layerChild, weightsSection, *precedingLayer, false);
    else if (layerType == "bnilstm")
    	return new NoIgLstmLayer<TDevice>(layerChild, weightsSection, *precedingLayer, true);
    else if (layerType == "niolstm")
    	return new NoIgOgLstmLayer<TDevice>(layerChild, weightsSection, *precedingLayer, false);
    else if (layerType == "bniolstm")
    	return new NoIgOgLstmLayer<TDevice>(layerChild, weightsSection, *precedingLayer, true);
    else if (layerType == "gru")
    	return new GruLayer<TDevice>(layerChild, weightsSection, *precedingLayer, false);
    else if (layerType == "bgru")
    	return new GruLayer<TDevice>(layerChild, weightsSection, *precedingLayer, true);
    else if (layerType == "sse" || layerType == "rsse" || layerType == "weightedsse" || layerType == "rmse" || layerType == "ce" || layerType == "wf" || layerType == "binary_classification" || layerType == "multiclass_classification") {
        ...
        else if (layerType == "rsse")
    	    return new RelativeSsePostOutputLayer<TDevice>(layerChild, *precedingLayer);
