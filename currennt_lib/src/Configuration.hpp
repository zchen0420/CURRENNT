...
private:
    ...
    optimizer_type_t m_optimizerType;
...
public:
    ...
    /**
     * Returns the beta1 for the adaptive moment optimizer
     *
     * @return The beta1 for the adaptive moment optimizer
     */
    real_t beta1() const;

    /**
     * Returns the beta2 for the adaptive moment optimizer
     *
     * @return The beta2 for the adaptive moment optimizer
     */
    real_t beta2() const;

    /**
     * Returns the rho for the adaptive delta optimizer
     *
     * @return The rho for the adaptive delta optimizer
     */
    real_t rho() const;

    /**
     * Returns the epsilon for the steepest descent or adaptive gradient optimizer
     *
     * @return The epsilon for the steepest descent or adaptive gradient optimizer
     */
    real_t epsilon() const;
    ...
    /**
    * Returns true if the recordMultiplyers shall be included in inputs
    *
    * @return True if the recordMultiplyers shall be included in inputs
    */
    bool includingMultiplyers() const;
