...
#ifndef LAYERS_RELATIVESSEPOSTOUTPUTLAYER_HPP
#define LAYERS_RELATIVESSEPOSTOUTPUTLAYER_HPP
...
namespace layers {
    ...
    class RelativeSsePostOutputLayer : public PostOutputLayer<TDevice>
    {
    public:
        /**
         ...
         * Destructs the Layer
         */
        virtual ~RelativeSsePostOutputLayer();
...
#endif // LAYERS_RELATIVESSEPOSTOUTPUTLAYER_HPP
