...
#ifndef OPTIMIZERS_ADAGRADOPTIMIZER_HPP
#define OPTIMIZERS_ADAGRADOPTIMIZER_HPP
...
namespace optimizers {
    ...
    /******************************************************************************************//**
     * Optimizer that uses adaptive gradient descent
     *
     * @param TDevice The computation device (Cpu or Gpu)
     *********************************************************************************************/
    template <typename TDevice>
    class AdaGradOptimizer : public Optimizer<TDevice>
    {
    ...
    public:
         ...
         * @param epsilon         The epsilon prevent from zero dividing
         */
        AdaGradOptimizer(
...
#endif // OPTIMIZERS_ADAGRADOPTIMIZER_HPP
