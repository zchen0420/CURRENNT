...
#ifndef OPTIMIZERS_ADADELTAOPTIMIZER_HPP
#define OPTIMIZERS_ADADELTAOPTIMIZER_HPP
...
namespace optimizers {
    ...
    class AdaDeltaOptimizer : public Optimizer<TDevice>
    {
    ...
    private:
        ...
        std::vector<real_vector> m_ssGrads;
        std::vector<real_vector> m_ssDeltas;
    ...
    public:
         ...
         * @param rho             The AdaDelta hyperparam
         * @param epsilon         The AdaDelta hyperparam
         */
        AdaDeltaOptimizer(
...
#endif // OPTIMIZERS_ADADELTAOPTIMIZER_HPP
